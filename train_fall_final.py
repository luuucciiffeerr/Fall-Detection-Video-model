"""
Fall Detection Training Pipeline v3.0 - FINAL FIX v2
R(2+1)D-18 + Class Weighting + Smart Sampling
FIXES: 
  1. CSV column names (num_frames not numframes)
  2. Numpy transpose instead of permute (numpy.ndarray doesn't have permute)
"""
    ...
    def __getitem__(self, idx):
        ...
        for attempt in range(3):
            try:
                ...
                # CRITICAL FIX #1: Use 'num_frames' not 'numframes'
                ...
                # CRITICAL FIX #2: Use np.transpose not .permute() for numpy arrays
                # clipnp is (T, H, W, 3) - need (3, T, H, W) for 3D CNN
...
def main():
    print("\n" + "=" * 80)
    print("Fall Detection Training Pipeline v3.0 - FINAL FIX")
