...
Optimized for RTX 3070 with R(2+1)D-18 backbone
Fixes: Class weighting, smart sampling, pretrained backbone, early stopping
"""
...
def build_videos_csv(dataroot: str, csvpath: str) -> str:
    ...
    df = pd.DataFrame(data, columns=[
        "filename", "path", "numframes", "fps", "width", "height", 
        "durationsec", "label"
    ])
...
def main():
    ...
    if not os.path.exists(ZIPPATH):
        raise FileNotFoundError(f"Put {ZIPPATH} in this folder")
